...
public final class MysteryBoosterCommanderEdition extends ExpansionSet {
    ...
    private MysteryBoosterCommanderEdition() {
        ...
        cards.add(new SetCardInfo("Chief Magistrate of Mercadia", 35, Rarity.RARE, mage.cards.c.ChiefMagistrateOfMercadia.class));
        ...
        cards.add(new SetCardInfo("Ekthi, Contaminator Priest", 1, Rarity.RARE, mage.cards.e.EkthiContaminatorPriest.class));
